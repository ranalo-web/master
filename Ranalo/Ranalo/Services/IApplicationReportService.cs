...
namespace Ranalo.Services
{
    public interface IApplicationReportService
    {
        ...
        Task<AwaitingApprovalViewModel> GetAwaitingApprovalOrdersByUser(int userId, string searchTerm = "", int page = 1, int pageSize = 10, int? dealerIdOverride = null, int? agentUserId = null);
